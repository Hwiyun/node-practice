...
3. 패키지 설치
    ...
    3) 패키지 설치 실습
        ...
        $ npm i -g gulp     [global, general dependancy]
        $ npx gulp --version
    4) 패키지 삭제
...
6. helloweb-ex01: 웹애플리케이션 만들어보기(express 프레임워크 x)
7. helloweb-ex02: 웹애플리케이션 만들어보기(express 프레임워크 o)